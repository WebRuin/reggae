	...
	<body <?php body_class(); ?> itemscope itemtype="http://schema.org/WebPage">
		...
		<div id="container">
			...
			<header class="header" role="banner" itemscope itemtype="http://schema.org/WPHeader">
				...
				<div id="inner-header" class="nav-home">

          <p itemscope itemtype="http://schema.org/Organization"><a class="logo" href="<?php echo home_url(); ?>" rel="nofollow"><?php bloginfo('name'); ?></a></p>
          
          <section class="social-media-links">
            <div class="tooltip--bottom" data-tooltip="RSS"><i class="fas fa-rss fa-2x"></i></div>
            <div class="tooltip--bottom" data-tooltip="iTunes"><i class="fab fa-itunes fa-2x"></i></i></div>
            <div class="tooltip--bottom" data-tooltip="Google Play"><i class="fab fa-google-play fa-2x"></i></div>
          </section>
